...
public interface TagsApi {
    ...
    @Operation(summary = "Get tags", description = "Get tags. Auth not required", tags={ "Tags" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Tags", content = @Content(mediaType = "application/json", schema = @Schema(implementation = InlineResponse2005.class))),
    ...
    ResponseEntity<InlineResponse2005> getTags();
